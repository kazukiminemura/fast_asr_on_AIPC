...
Raptor mini (Preview) などの AIPC 上で、`neosophie/Qwen3-ASR-1.7B-JA` を使った日本語音声認識をリアルタイム寄りに実行する。
...
- ASR model: `neosophie/Qwen3-ASR-1.7B-JA`
...
3. モデルが `neosophie/Qwen3-ASR-1.7B-JA` になっていることを確認する
4. 推論デバイスを選ぶ
